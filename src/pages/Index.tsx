  ...
  const features = [
    {
      ...
      description: "Learn from experienced pilots with real-world aviation expertise and industry insights."
    },
    {
      icon: Heart,
      title: "Personalized Mentorship",
      description: "One-on-one guidance tailored to your learning pace and career goals."
    },
    {
      icon: Target,
      title: "Practical & Engaging Learning",
      description: "Hands-on training with interactive sessions that prepare you for real aviation scenarios."
    },
    {
      icon: BookOpen,
      title: "Industry-Relevant Curriculum", 
      description: "Up-to-date courses aligned with DGCA standards and industry requirements."
    },
    {
      icon: Users,
      title: "Supportive Aviators' Community",
      description: "Join a network of aspiring pilots and aviation professionals for ongoing support."
    }
  ];
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 animate-fade-in">
            Fly With Those Who've<br />Been There. Done That.
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-4xl mx-auto leading-relaxed animate-slide-in-left" style={{ animationDelay: "200ms" }}>
            At Gypsy Aviators Aviation Academy, you're not just learning from trainers—you're learning from real pilots.
          </p>
          <Button 
            size="lg" 
        ...
        <div className="container-custom">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed animate-slide-in-right">
              With 7+ years of hands-on aviation experience, industry insights, and a passion for mentoring, 
              we shape aviators and turn your dream of flying into reality.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {programs.map((program, index) => (
              <div key={program.title} className="animate-slide-in-left" style={{ animationDelay: `${index * 100}ms` }}>
                <ProgramCard
                  icon={program.icon}
                  title={program.title}
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 animate-slide-in-left">
              Whether you have questions, need guidance, or are ready to enroll—we're here to help.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              ...
              <Card className="bg-card border-border shadow-card text-center animate-scale-in" style={{ animationDelay: "100ms" }}>
                <CardContent className="p-6">
                  <Mail className="h-8 w-8 text-primary mx-auto mb-4" />
                  <h3 className="font-semibold text-card-foreground mb-2">Email</h3>
                  <p className="text-muted-foreground">gypsyaviators@gmail.com</p>
                </CardContent>
              </Card>
              
              <Card className="bg-card border-border shadow-card text-center animate-scale-in" style={{ animationDelay: "200ms" }}>
                <CardContent className="p-6">
